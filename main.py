...
class Message(db.Model):
    ...
    group_id   = db.Column(db.String(36))          # None → личное
    sender     = db.Column(db.String(80), db.ForeignKey("users.username"))
    receiver   = db.Column(db.String(80))          # для ЛС
...
class Route(db.Model):
    ...
    points  = db.relationship("RoutePoint",  backref="route",
                              cascade="all,delete")
    comments = db.relationship("RouteComment", backref="route",
                               cascade="all,delete")
